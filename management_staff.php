...
if (isset($_POST['save'])) {
    ...
    header("Location: ./?link=management_staff.php&ok=1");
    exit;
}
/* ===============================
ROLE FILTERING
...
$where = "WHERE s.registry_type='management'";
...
<div class="card p-4 mb-4">
    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
        ...
        <div>
            <h2 class="text-white fw-bold mb-1">Management Staff Registry</h2>
    ...
    <form method="post" enctype="multipart/form-data" class="row g-3">
        ...
        <div class="col-md-4">
            ...
            <select name="position_trade" class="form-select" required>
                ...
                <?php foreach ($management_positions as $pos): ?>
